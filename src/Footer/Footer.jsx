        ...
        <footer className="hero">
          ...
          <div className="container-pages flex">
            ...
            <div className="container__more">
                <h2>Contact US</h2>
                <ul>
                    <li><a href="https://www.instagram.com/iam_gaur8av/">Instagram</a></li>
                </ul>
                <ul>
                    <li><a href="https://github.com/deepeshmlgupta">Github</a></li>
                </ul><ul>
                    <li><a href="https://www.linkedin.com/in/deepeshmlgupta/">LinkedIn</a></li>
                </ul>
                <ul>
                    <li><a href="mailto:deepeshmlgupta@gmail.com">Email</a></li>
                </ul>
                <ul>
          ...
          <div className="line_separete">
            <div className="by flex">
                <p style={{display:"flex"}}>Cpoyright <BsCCircle style={{margin:"5px 10px"}}/>2024 - {new Date().getFullYear()} All Righta are reserved by M & M team</p>
                <div className="icons">
                    <a href="https://www.instagram.com/iam_gaur8av/" className="icon1 icon--instagram">
                        <i><AiOutlineInstagram/></i>
                    </a>
                    <a href="https://www.youtube.com/" className="icon1 icon--twitter">
                        <i><FaYoutube/></i>
                    </a><a href="https://www.linkedin.com/in/deepeshmlgupta/" className="icon1 icon--linkedin">
                        <i><AiOutlineLinkedin/></i>
                    </a>
                    <a href="https://github.com/deepeshmlgupta" className="icon1 icon--github">
                        <i><AiOutlineGithub/></i>
                    </a>
                </div>
            </div>

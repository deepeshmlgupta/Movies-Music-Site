...
export default function Player(){
    ...
    return(
        ...
        {user ?<>
        <SuperSEO
        title={`M & M - ${Title.split("_").join(" ")} ||  Watch Free online or Download`}
        ...
        twitter={{
            ...
            summaryCardSiteUsername: "iam_gaur8av",
            },
        }}
        />
        <SuperSEO
        ...
        <Helmet>
        <title>{`M & M - ${Title.split("_").join(" ")} ||  Watch Free online or Download`}</title>
        <meta name="description" content={`Watch - ${Title.split("_").join(" ")} for free or Download in Full HD`} />
        <meta itemprop="name" content={`M & M - ${Title.split("_").join(" ")} ||  Watch Free online or Download`}></meta>
        ...
        <meta name="twitter:site" content="@iam_gaur8av"></meta>
        ...
        <meta name="twitter:creator" content="@iam_gaur8av"></meta>
        ...
        <div className="share">
            ...
            <a href={`https://www.facebook.com/sharer.php?u=https://github.com/deepeshmlgupta/Movies-Music-Site`} target="_blank" rel="noreferrer">
                <FacebookIcon size={32} borderRadius={10} />
            </a>
            <a href={`https://twitter.com/intent/tweet?text=Watch ${Title.split("_").join(" ")} For Free Copy link from and open in new tab&url=https://github.com/deepeshmlgupta/Movies-Music-Site`} style={{margin:"0px 0px 0px 20px"}} target="_blank" rel="noreferrer">
                <TwitterIcon size={32} borderRadius={10} />
            </a>
            <a href={`https://api.whatsapp.com/send?text=[${Title.split("_").join(" ")}] [Watch Now For Free or Download in HD] [https://github.com/deepeshmlgupta/Movies-Music-Site]`} borderRadius={10} style={{margin:"0px 0px 0px 20px"}} target="_blank" rel="noreferrer">
                <WhatsappIcon size={32} borderRadius={10} />
            </a>
            <a href={`http://pinterest.com/pin/create/button/?url=https://github.com/deepeshmlgupta/Movies-Music-Site&media=${Image.split("---").join("/")}&description=${Title.split("_").join(" ")} ||  Watch Free online or Download`} style={{margin:"0px 0px 0px 20px"}} target="_blank" rel="noreferrer">
                <PinterestIcon size={32} borderRadius={10} />
            </a>
            <a href={`mailto:?subject=${Title.split("_").join(" ")}&body=https://github.com/deepeshmlgupta/Movies-Music-Site`} style={{margin:"0px 0px 0px 20px"}} target="_blank" rel="noreferrer">
                <EmailIcon size={32} borderRadius={10} />
            </a>
            <CopyToClipboard text="https://github.com/deepeshmlgupta/Movies-Music-Site" onCopy={oncopy}>
